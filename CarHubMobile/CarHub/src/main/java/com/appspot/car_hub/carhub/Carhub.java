...
public class Carhub extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Expense {
     ...
     * @return the request
     */
    public Update update(java.lang.String serverId, com.appspot.car_hub.carhub.model.UserExpenseRecord content) throws java.io.IOException {
    ...
    public class Update extends CarhubRequest<com.appspot.car_hub.carhub.model.UserExpenseRecord> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String serverId, com.appspot.car_hub.carhub.model.UserExpenseRecord content) {
        super(Carhub.this, "POST", REST_PATH, content, com.appspot.car_hub.carhub.model.UserExpenseRecord.class);
  ...
  public class Fuel {
     ...
     * @return the request
     */
    public Update update(java.lang.String serverId, com.appspot.car_hub.carhub.model.FuelRecord content) throws java.io.IOException {
      Update result = new Update(serverId, content);
      initialize(result);
      return result;
    }
    ...
    public class Update extends CarhubRequest<com.appspot.car_hub.carhub.model.FuelRecord> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String serverId, com.appspot.car_hub.carhub.model.FuelRecord content) {
        super(Carhub.this, "POST", REST_PATH, content, com.appspot.car_hub.carhub.model.FuelRecord.class);
        this.serverId = com.google.api.client.util.Preconditions.checkNotNull(serverId, "Required parameter serverId must be specified.");
      }
  ...
  public class Maintenance {
     ...
     * @return the request
     */
    public Update update(java.lang.String serverId, com.appspot.car_hub.carhub.model.MaintenanceRecord content) throws java.io.IOException {
      Update result = new Update(serverId, content);
      initialize(result);
      return result;
    }
    ...
    public class Update extends CarhubRequest<com.appspot.car_hub.carhub.model.MaintenanceRecord> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String serverId, com.appspot.car_hub.carhub.model.MaintenanceRecord content) {
        super(Carhub.this, "POST", REST_PATH, content, com.appspot.car_hub.carhub.model.MaintenanceRecord.class);
        this.serverId = com.google.api.client.util.Preconditions.checkNotNull(serverId, "Required parameter serverId must be specified.");
      }
  ...
  public class Vehicle {
     ...
     * @return the request
     */
    public Update update(java.lang.String serverId, com.appspot.car_hub.carhub.model.UserVehicle content) throws java.io.IOException {
      Update result = new Update(serverId, content);
      initialize(result);
      return result;
    }
    ...
    public class Update extends CarhubRequest<com.appspot.car_hub.carhub.model.UserVehicle> {
       ...
       * @since 1.13
       */
      protected Update(java.lang.String serverId, com.appspot.car_hub.carhub.model.UserVehicle content) {
        super(Carhub.this, "POST", REST_PATH, content, com.appspot.car_hub.carhub.model.UserVehicle.class);
        this.serverId = com.google.api.client.util.Preconditions.checkNotNull(serverId, "Required parameter serverId must be specified.");
      }
