...
public class Carhub extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Expense {
     ...
     *
     * @param content the {@link com.google.api.services.carhub.model.BaseExpense}
     * @return the request
     */
    public Delete delete(com.google.api.services.carhub.model.BaseExpense content) throws java.io.IOException {
      Delete result = new Delete(content);
      initialize(result);
      return result;
    }

    public class Delete extends CarhubRequest<com.google.api.services.carhub.model.BaseExpense> {
       ...
       * @since 1.13
       */
      protected Delete(com.google.api.services.carhub.model.BaseExpense content) {
        super(Carhub.this, "POST", REST_PATH, content, com.google.api.services.carhub.model.BaseExpense.class);
      }
     ...
     * @return the request
     */
    public Store store(com.google.api.services.carhub.model.BaseExpense content) throws java.io.IOException {
      Store result = new Store(content);
      initialize(result);
      return result;
    }

    public class Store extends CarhubRequest<com.google.api.services.carhub.model.BaseExpense> {
       ...
       * @since 1.13
       */
      protected Store(com.google.api.services.carhub.model.BaseExpense content) {
        super(Carhub.this, "POST", REST_PATH, content, com.google.api.services.carhub.model.BaseExpense.class);
      }
