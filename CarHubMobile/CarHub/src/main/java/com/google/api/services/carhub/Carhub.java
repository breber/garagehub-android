...
public class Carhub extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Expense {
     ...
     * @return the request
     */
    public Update update(com.google.api.services.carhub.model.UserExpenseRecord content) throws java.io.IOException {
    ...
    public class Update extends CarhubRequest<com.google.api.services.carhub.model.UserExpenseRecord> {
      ...
      private static final String REST_PATH = "expense/update/{key}";
       ...
       * @since 1.13
       */
      protected Update(com.google.api.services.carhub.model.UserExpenseRecord content) {
        super(Carhub.this, "POST", REST_PATH, content, com.google.api.services.carhub.model.UserExpenseRecord.class);
      }
  ...
  public class Fuel {
     ...
     * @return the request
     */
    public Update update(com.google.api.services.carhub.model.FuelRecord content) throws java.io.IOException {
      Update result = new Update(content);
      initialize(result);
      return result;
    }
    ...
    public class Update extends CarhubRequest<com.google.api.services.carhub.model.FuelRecord> {
      ...
      private static final String REST_PATH = "fuel/update/{key}";
       ...
       * @since 1.13
       */
      protected Update(com.google.api.services.carhub.model.FuelRecord content) {
        super(Carhub.this, "POST", REST_PATH, content, com.google.api.services.carhub.model.FuelRecord.class);
      }
  ...
  public class Maintenance {
     ...
     * @return the request
     */
    public Update update(com.google.api.services.carhub.model.MaintenanceRecord content) throws java.io.IOException {
      Update result = new Update(content);
      initialize(result);
      return result;
    }
    ...
    public class Update extends CarhubRequest<com.google.api.services.carhub.model.MaintenanceRecord> {
      ...
      private static final String REST_PATH = "maintenance/update/{key}";
       ...
       * @since 1.13
       */
      protected Update(com.google.api.services.carhub.model.MaintenanceRecord content) {
        super(Carhub.this, "POST", REST_PATH, content, com.google.api.services.carhub.model.MaintenanceRecord.class);
      }
